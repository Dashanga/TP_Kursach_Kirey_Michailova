namespace BeautyServiceImplementDataBase.Migrations
{
    ...
    public partial class FirstMigration : DbMigration
    {
        public override void Up()
        {
            ...
            DropTable("dbo.ApplicationResourses");
            CreateTable(
                "dbo.ApplicationResourses",
                c => new
                    {
                        ApplicationResourseId = c.Int(nullable: false, identity: true),
                        ApplicationId = c.Int(nullable: false),
                        ResourseId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ApplicationResourseId);
            CreateTable(
                "dbo.Applications",
                c => new
                    {
